...
year1_features1 = year1_weeks['avg_daily_return']
year1_features2 = year1_weeks['avg_volatility']
year1_labels = year1_weeks['label']
df, location1, scale1 = stats.t.fit(year1_features1)
df, location2, scale2 = stats.t.fit(year1_features2)
...
year2_features1 = year2_weeks['avg_daily_return']
year2_features2 = year2_weeks['avg_volatility']
year2_labels = year2_weeks['label']

# df, location3, scale3 = stats.t.fit(year2_features1)
# df, location4, scale4 = stats.t.fit(year2_features2)

labels = []
for df in [0.5, 1, 1.5]:
	t_year1_features1 = stats.t.pdf(year1_features1, df, location1, scale1)
	t_year1_features2 = stats.t.pdf(year1_features2, df, location2, scale2)
	t_year1_features = np.vstack((t_year1_features1, t_year1_features2)).T
	model = GaussianNB()
	model.fit(t_year1_features, year1_labels)
	...
	df, location3, scale3 = stats.t.fit(year2_features1)
	df, location4, scale4 = stats.t.fit(year2_features2)
	t_year2_features1 = stats.t.pdf(year2_features1, df, location3, scale3)
	t_year2_features2 = stats.t.pdf(year2_features2, df, location4, scale4)
	t_year2_features = np.vstack((t_year2_features1, t_year2_features2)).T
	pred_lst = model.predict(t_year2_features)

	labels.append(pred_lst)
...
year2_weeks['pred_label'] = labels[1]
